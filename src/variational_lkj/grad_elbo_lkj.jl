...
function grad_and_logp_elbo_lkj(
    ...
    # Compute likelihood:
    logp = logp_unpacked_params_lkj(log_ξ, ξ, log_τ, τ, atanh_ρ, C, inv_S_vec, P_root, P_rootβrs, Mlik, K, J, Tsubp, a_γ, b_γ)
    ...
    grad_atanh_ρ = grad_logp_conditional_ρ(atanh_ρ, β, P_root, vec_MliktMlik_t, J, K, Tsubp) # checked!

    # Concatenate gradients
    grad_θ = vcat(grad_β, grad_log_ξ, grad_log_τ, grad_atanh_ρ)
