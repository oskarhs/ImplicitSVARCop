...
function test_example()
    ...
    # Compute the VI posterior to get initial values for 
    ...
    # it also helps with numerical stability; the gradients tend to be very large leading to very large proposed steps, frequently causing numerical problems when attempting to find a good initial stepsize.
    θ_init = posterior.μ
