...
"""
function logp_conditional_γ(γ::AbstractVector{<:Real}, C::AbstractMatrix, transformed_dist, β::AbstractVector, P_root::AbstractArray, Mlik::AbstractArray, J::Int, K::Int, Tsubp::Int)
